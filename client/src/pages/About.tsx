...
export default function About() {
  return (
    <div className="pt-24 md:pt-28">
      {/* Hero */}
      <section className="py-20" style={{ background: "linear-gradient(135deg, #e8f5d8 0%, #c8e49a 100%)" }}>
        <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#1a2e0a" }}>
              ABOUT <span style={{ color: "#77A734" }}>REGAN GROUP</span> SERVICES
            </h1>
            <p className="text-base leading-relaxed mb-4" style={{ color: "#3d5a1a" }}>
            ...
            <p className="text-base leading-relaxed" style={{ color: "#3d5a1a" }}>
      ...
      {/* Stats */}
      <section style={{ background: "#77A734" }} className="py-10">
        <div className="container grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={i}>
              ...
              <div className="text-sm mt-1" style={{ color: "#b8d880" }}>{s.label}</div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="container max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-extrabold" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#1a2e0a" }}>
              BUILT ON <span style={{ color: "#77A734" }}>EXPERIENCE</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="rounded-2xl p-8" style={{ background: "#f0fbea", border: "1.5px solid #dff0c0" }}>
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{ background: "#77A734", color: "#fff" }}>
                <Users size={24} />
              </div>
              <h3 className="text-2xl font-bold mb-3" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#1a2e0a" }}>A Family Business</h3>
              <p className="text-sm leading-relaxed" style={{ color: "#4a6a2a" }}>
      ...
      <section className="py-20" style={{ background: "#f0fbea" }}>
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-extrabold" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#1a2e0a" }}>
              OUR <span style={{ color: "#77A734" }}>VALUES</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div key={i} className="rounded-2xl p-6 text-center" style={{ background: "#fff", border: "1.5px solid #dff0c0" }}>
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: "#e8f5d8", color: "#77A734" }}>
                  {v.icon}
                </div>
                <h3 className="text-xl font-bold mb-2" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#1a2e0a" }}>{v.title}</h3>
                <p className="text-sm leading-relaxed" style={{ color: "#4a6a2a" }}>{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#1a2e0a" }}>
                AREAS WE <span style={{ color: "#77A734" }}>SERVE</span>
              </h2>
              <p className="text-base leading-relaxed mb-6" style={{ color: "#4a6a2a" }}>
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                {["Central London", "East London", "North London", "South London", "West London", "Essex", "Hertfordshire", "Kent"].map((area) => (
                  <div key={area} className="flex items-center gap-2 text-sm" style={{ color: "#2d4a1a" }}>
                    <div className="w-2 h-2 rounded-full" style={{ background: "#77A734" }} /> {area}
                  </div>
                ))}
              </div>
