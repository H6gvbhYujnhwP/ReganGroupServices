    ...
    <footer style={{ background: "#1a2e0a", color: "#fff" }}>
      ...
      <div className="container py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="font-bold text-lg" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#5B9E1F" }}>REGAN GROUP</div>
              <div className="text-xs tracking-widest" style={{ color: "#D4A017" }}>SERVICES LTD</div>
            </div>
          </div>
          <p className="text-sm leading-relaxed" style={{ color: "#a8c88a" }}>
          ...
          <div className="mt-4 flex gap-3">
            {["f", "in", "tw"].map((s) => (
              <a
                ...
                style={{ background: "#2d4a1a", color: "#5B9E1F" }}
              >
                {s.toUpperCase()}
              </a>
            ))}
        ...
        {/* Services */}
        <div>
          <h4 className="font-bold mb-4 text-lg" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#5B9E1F" }}>OUR SERVICES</h4>
          <ul className="space-y-2">
            {["Plumbing", "Drainage & CCTV", "Door Entry Systems", "Service Packages", "Emergency Call Out", "Planned Maintenance"].map((s) => (
              <li key={s}>
                <Link href="/services" className="flex items-center gap-2 text-sm transition-colors hover:text-white" style={{ color: "#a8c88a" }}>
        ...
        {/* Quick Links */}
        <div>
          <h4 className="font-bold mb-4 text-lg" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#5B9E1F" }}>QUICK LINKS</h4>
          <ul className="space-y-2">
            {[
              { href: "/", label: "Home" },
              ...
              <li key={l.href}>
                <Link href={l.href} className="flex items-center gap-2 text-sm transition-colors hover:text-white" style={{ color: "#a8c88a" }}>
        ...
        {/* Contact */}
        <div>
          <h4 className="font-bold mb-4 text-lg" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#5B9E1F" }}>CONTACT US</h4>
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              <Phone size={16} style={{ color: "#D4A017", marginTop: 2 }} />
              <div>
                <div className="text-xs" style={{ color: "#a8c88a" }}>Phone</div>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <div className="text-xs" style={{ color: "#a8c88a" }}>Email</div>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <div className="text-xs" style={{ color: "#a8c88a" }}>Areas Served</div>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <div className="text-xs" style={{ color: "#a8c88a" }}>Emergency</div>
      ...
      <div className="border-t py-5" style={{ borderColor: "#2d4a1a" }}>
        <div className="container flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs" style={{ color: "#a8c88a" }}>
            © {new Date().getFullYear()} Regan Group Services Ltd. All rights reserved. Registered in England & Wales.
          </p>
          <div className="flex gap-4">
            {["Privacy Policy", "Terms of Service"].map((t) => (
              <a key={t} href="#" className="text-xs transition-colors hover:text-white" style={{ color: "#a8c88a" }}>{t}</a>
            ))}
          </div>
        </div>
      </div>
